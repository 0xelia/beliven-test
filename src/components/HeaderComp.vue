    ...
    <header>
        ...
        <div class="container">
            ...
            <nav class="flex pt-4 pb-2 justify-between items-center border-0 border-b-[1px] border-b-gray-300">
                ...
                <button class="text-lg text-white bg-blue-800 px-6 py-1 rounded-md cursor-pointer   ">New Project</button>
            </nav>
            <div class="py-2 flex justify-between gap-2 border-b-[1px] border-b-gray-300">
                <!-- filter bar -->
